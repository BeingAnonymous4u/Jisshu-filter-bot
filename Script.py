...
ᴍʏ ɴᴀᴍᴇ ɪꜱ <a href="tg://user?id=7279421338">Movies Series Search Bot</a>, ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇꜱ & ꜱᴇʀɪᴇꜱ ᴊᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ Aɴᴅ Eɴᴊᴏʏ ??</b>"""
...
🎁 ʀᴇǫᴜᴇꜱᴛ ᴍꜱɢ - <code>{}</code></b>"""  
    ...
    IMDB_TEMPLATE_TXT = """
<b>ʜᴇʏ {message.from_user.mention}, ʜᴇʀᴇ ɪꜱ ᴛʜᴇ ʀᴇꜱᴜʟᴛꜱ ꜰᴏʀ ʏᴏᴜʀ ǫᴜᴇʀʏ <code>{search}</code>
...
‣ <b>Yᴏᴜ Aʀᴇ Nᴏᴛ Vᴇʀɪғɪᴇᴅ Tᴏᴅᴀʏ</b>
Pʟᴇᴀꜱᴇ  Vᴇʀɪғʏ Tᴏ Gᴇᴛ Uɴʟɪᴍɪᴛᴇᴅ Dᴏᴡɴʟᴏᴀᴅɪɴɢ Aᴄᴄᴇꜱꜱ Tɪʟʟ Nᴇxᴛ Vᴇʀɪғɪᴄᴀᴛɪᴏɴ. 
Wᴀɴᴛs ᴀ Dɪʀᴇᴄᴛ Fɪʟᴇ's Aɴᴅ Sᴛʀᴇᴀᴍɪɴɢ Fᴇᴀᴛᴜʀᴇ, Wɪᴛʜᴏᴜᴛ Vᴇʀɪғɪᴄᴀᴛɪᴏɴ ? Sᴇᴇ Oᴜʀ Pʀɪᴍɪᴜᴍ Pʟᴀɴs
👉 /plan
Sᴇᴇ Yᴏᴜʀ Cᴜʀʀᴇɴᴛ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ 
👉 /myplan

आज आपने Vᴇʀɪғʏ नहीं किया है। कृपया असीमित डाउनलोडिंग एक्सेस प्राप्त करने के लिए सत्यापन करें।
बिना Vᴇʀɪғʏ के सीधे फ़ाइल और स्ट्रीम सुविधा चाहते हैं तो हमारी प्रीमियम योजनाएँ देखें।
👉 /plan
...
ɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ᴛɪʟʟ ɴᴇxᴛ <code>{}</code> ❤️‍🔥
...
👉 /myplan
#2nd ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ
आज आपने Vᴇʀɪғʏ नहीं किया है। असीमित डाउनलोडिंग एक्सेस प्राप्त करने के लिए सत्यापन करें।
बिना Vᴇʀɪғʏ के सीधे फ़ाइल और स्ट्रीम सुविधा चाहते हैं तो हमारी प्रीमियम योजनाएँ देखें।
👉 /plan
अपनी वर्तमान सदस्यता देखें।
👉 /myplan"""
...
Kɪɴᴅʟʏ ᴠᴇʀɪғʏ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ Sᴏ ᴛʜᴀᴛ ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴀᴄᴄᴇss ᴛᴏ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs !

आप verified नहीं हैं ! 
कृपया जारी रखने के लिए verify करें ताकि आप unlimited फिल्मों प्राप्त कर सकें</b>"""

    THIRDT_VERIFY_COMPLETE_TEXT= """<b>👋 ʜᴇʏ {},
    
ʏᴏᴜ ʜᴀᴠᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ...
...
➛ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan</b>"""
 ...
 <blockquote>🎁 ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ ʟɪꜱᴛ :</blockquote>
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/AllFilesRobot">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/AllFilesRobot">Example</a>
--------------Set Tutorial-------------
