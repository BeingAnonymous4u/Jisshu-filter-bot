...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        btn = [[
            InlineKeyboardButton('Cʜᴇᴄᴋ Pʀɪᴍɪᴜᴍ Pʟᴀɴs 🏷️', callback_data='free')
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ʀᴇᴄᴇɪᴘᴛ 🧾', url=f'https://t.me/AllFilesRobot')
        ],[
    ...
    #jisshu
       ...
       buttons = [[
            InlineKeyboardButton('🍁 Cʜᴇᴄᴋ Pʀɪᴍɪᴜᴍ Pʟᴀɴs 🍁', callback_data='free')
        ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       ...
       await query.message.edit_media(
        ...
        buttons = [[
              InlineKeyboardButton('Aᴅᴍɪɴ Cᴍᴅ', callback_data='admincmd'),
...
async def auto_filter(client, msg, spoll=False , pm_mode = False):
	...
	InlineKeyboardButton("🗣️ ᴄʜᴏᴏsᴇ ʟᴀɴɢᴜᴀɢᴇ 🗣️", callback_data=f"languages#{key}#{offset}#{req}"),
            ...
            btn.insert(1, [
        InlineKeyboardButton("✨ ǫᴜᴀʟɪᴛʏ 🎊", callback_data=f"qualities#{key}#{offset}#{req}"),
	InlineKeyboardButton("🎭 sᴇᴀsᴏɴ 🏖️", callback_data=f"seasons#{key}#{offset}#{req}")
      ])    
        else:
            btn.insert(0,[
                InlineKeyboardButton("🗣️ ᴄʜᴏᴏsᴇ ʟᴀɴɢᴜᴀɢᴇ 🗣️", callback_data=f"languages#{key}#{offset}#{req}")
            ...
            btn.insert(1,[
                InlineKeyboardButton("♻️ Nᴏ Mᴏʀᴇ Pᴀɢᴇs Aᴠᴀɪʟᴀʙʟᴇ ♻️", callback_data="pages")
            ])
    else:
        btn.insert(0,[
